...
<Link to="/daylight-calculator" className="icon icon-orange">
...
<Link to="/hemming-tonnage" className="icon icon-green">
...
<Link to="/InsideRadiusCalculator" className="icon icon-blue">
...
<Link to="/machine-recommender" className="icon icon-purple">
...
<Link to="/robot-cycletime" className="icon icon-green">
...
<Link to="/robot-spec-guide" className="icon icon-blue">
...
<Link to="/tonnage-calculator" className="icon icon-purple">
    <MachineRecommenderIcon width={50} height={50} />
    <div className="icon-content">
