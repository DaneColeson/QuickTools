...
const weightMultipliers = [
  { maxWeight: 25, multiplier: 1 },
  { maxWeight: 35, multiplier: 1.1 },
  { maxWeight: 50, multiplier: 1.2 },
  { maxWeight: 75, multiplier: 1.3 },
  { maxWeight: 100, multiplier: 1.4 },
  { maxWeight: 200, multiplier: 1.5 },
];
...
const RobotCycleTime: React.FC = () => {
  ...
  const calculateCycleTime = () => {
    ...
    const adjustedCycleTime = baseCycleTime * cycleMultiplier;
